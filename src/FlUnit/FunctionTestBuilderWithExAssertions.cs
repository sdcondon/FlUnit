...
namespace FlUnit
{
    ...
    public sealed class FunctionTestBuilderWithExAssertions<TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<TResult> AndAsync(Func<Exception, Task> asyncAssertion, string description)
        {
    ...
    public sealed class FunctionTestBuilderWithExAssertions<T1, TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<T1, TResult> AndAsync(Func<T1, Exception, Task> asyncAssertion, string description)
        {
            assertions.Add(new AssertionImpl(asyncAssertion.ToAsyncWrapper(), description));
            return this;
        }
    ...
    public sealed class FunctionTestBuilderWithExAssertions<T1, T2, TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<T1, T2, TResult> AndAsync(Func<T1, T2, Exception, Task> asyncAssertion, string description)
        {
            assertions.Add(new AssertionImpl(asyncAssertion.ToAsyncWrapper(), description));
            return this;
        }
    ...
    public sealed class FunctionTestBuilderWithExAssertions<T1, T2, T3, TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<T1, T2, T3, TResult> AndAsync(Func<T1, T2, T3, Exception, Task> asyncAssertion, string description)
        {
            assertions.Add(new AssertionImpl(asyncAssertion.ToAsyncWrapper(), description));
            return this;
        }
    ...
    public sealed class FunctionTestBuilderWithExAssertions<T1, T2, T3, T4, TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<T1, T2, T3, T4, TResult> AndAsync(Func<T1, T2, T3, T4, Exception, Task> asyncAssertion, string description)
        {
            assertions.Add(new AssertionImpl(asyncAssertion.ToAsyncWrapper(), description));
            return this;
        }
    ...
    public sealed class FunctionTestBuilderWithExAssertions<T1, T2, T3, T4, T5, TResult>
    {
        ...
        /// <param name="description">The description of the assertion.</param>
        /// <returns>A builder for providing additional assertions for the test.</returns>
        public FunctionTestBuilderWithExAssertions<T1, T2, T3, T4, T5, TResult> AndAsync(Func<T1, T2, T3, T4, T5, Exception, Task> asyncAssertion, string description)
        {
            assertions.Add(new AssertionImpl(asyncAssertion.ToAsyncWrapper(), description));
            return this;
        }
