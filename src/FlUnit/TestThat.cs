...
namespace FlUnit
{
    ...
    public static class TestThat
    {
        ...
        public static TestBuilderWithPrerequisites<T> Given<T>(Func<T> prerequisite) => new TestBuilderWithPrerequisites<T>(new Action<ITestConfiguration>[] { }, () => new[] { prerequisite() });
        ...
        /// <returns>A builder for providing more "Given" clauses or a "When" clause.</returns>
        public static TestBuilderWithPrerequisites<T> GivenEachOf<T>(Func<IEnumerable<T>> prerequisites) => new TestBuilderWithPrerequisites<T>(new Action<ITestConfiguration>[] { }, prerequisites);
        ...
        public static TestBuilderWithAction When(Action testAction) => new TestBuilderWithAction(new Action<ITestConfiguration>[] { }, testAction);
        ...
        /// <returns>A builder for providing "Then" clauses.</returns>
        public static TestBuilderWithFunction<T> When<T>(Func<T> testFunction) => new TestBuilderWithFunction<T>(new Action<ITestConfiguration>[] { }, testFunction);
    }
}
