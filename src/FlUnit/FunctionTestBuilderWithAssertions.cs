...
namespace FlUnit
{
    ...
    public sealed class FunctionTestBuilderWithAssertions<T1, T2, T3, T4, TResult>
    {
        ...
        internal class AssertionImpl
        {
            ...
            internal AssertionImpl(Action<T1, T2, T3, T4, TestFunctionOutcome<TResult>> assert, string description)
            {
                this.assert = assert;
                Description = description;
            }
            ...
            internal void Invoke(T1 a1, T2 a2, T3 a3, T4 a4, TestFunctionOutcome<TResult> outcome) => assert(a1, a2, a3, a4, outcome);
    ...
    public sealed class FunctionTestBuilderWithAssertions<T1, T2, T3, T4, T5, TResult>
    {
        ...
        internal class AssertionImpl
        {
            ...
            internal AssertionImpl(Action<T1, T2, T3, T4, T5, TestFunctionOutcome<TResult>> assert, string description)
            {
                this.assert = assert;
                Description = description;
            }
            ...
            internal void Invoke(T1 a1, T2 a2, T3 a3, T4 a4, T5 a5, TestFunctionOutcome<TResult> outcome) => assert(a1, a2, a3, a4, a5, outcome);
