...
namespace FlUnit.Adapters
{
    ...
    {
        /// <inheritdoc />
        public string GetResultLabel(Test test, ITestCase testCase, ITestAssertion assertion)
        {
            ...
            {
                // TODO-MAINTAINABILITY: bad - VSTest-specific behaviour. Sort this out ideally by changing the ITestContainer interface to talk unequivacably in FlUnit terms,
